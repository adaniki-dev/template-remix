...
const booleanFields: (keyof FormValues)[] = ['activeCaptureLead', 'canMessageAdmin'];

export function PopoverAdvancedFilter() {
          ...
          {({ isSubmitting, ...formikHelpers }) => (
            <div className="grid gap-4">
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">Filtre os grupos por atributos</p>
              </div>
