...
export default function InputNumberWithValidation(props: PhoneBadgeInputProps) {
  ...
  function handleAddPhone() {
    ...
    setFieldValue('phones', [...field.value, numericPhone]);
    setPhoneInput('');
  }
    ...
    <div className="flex flex-col">
      <div className="flex items-center gap-2">
        <Label className="text-sm" htmlFor={props.name}>
          {props.label ?? 'Adicione os contatos administrativos'}
        </Label>
      </div>
          ...
          <div>
            <div className="flex items-center gap-2">
              <Input
                ...
                placeholder={props.placeholder ?? 'Adicione os contatos administrativos'}
              />
