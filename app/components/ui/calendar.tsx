  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: 'space-y-4 space-x-0',
        month_caption: 'flex justify-center pt-1 relative  items-center',
        caption_label: 'text-sm font-medium',
        nav: 'space-x-1 flex items-center absolute w-full',
        button_previous: cn(
          buttonVariants({ variant: 'outline' }),
          'h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 aboslute left-1 z-10',
        ),
        button_next: cn(
          buttonVariants({ variant: 'outline' }),
        ...
        selected:
          'bg-primary rounded-lg text-gray-50 hover:bg-primary hover:text-gray-50 focus:bg-gray-900 focus:text-gray-50',
